...
$(document).ready(function(){
    ...
    if($('body').width() > 768) {
        ...
        $(".sonp-section").each(function(index){
            ...
            if (come(".sonp-section-"+index)) {
                $('.sonp-navigation-item[data-section="'+index+'"]').addClass('active');
            }
        });
        ...
        $(".sonp-navigation-item").click(function(){
            ...
            $('.sonp-navigation-item').removeClass('active');
            $('.sonp-navigation-item[data-section="'+section+'"]').addClass('active');
        });
...
$.fn.nextPage = function () {
    ...
    if(pageIndex < pagesMax-1){
        ...
        pageIndex++;
        $('.sonp-navigation-item').removeClass('active');
        $('.sonp-navigation-item[data-section="'+pageIndex+'"]').addClass('active');
